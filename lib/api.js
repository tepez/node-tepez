...
class TepezApi {
    ...
    getForm(options) {
        Joi.assert(options, Joi.object().keys({
            formId: reqObjectIdType.required(),
        ...
        return this._signinIfNeeded().then(() => {
            ...
            const requestOptions = {
                method: 'GET',
                url: `${this.options.baseUrl}/v1.0/form/${options.formId}`,
                time: true,
                json: true,
                qs: qs,
    ...
    listForms(options) {
        ...
        return this._signinIfNeeded().then(() => {
            ...
            const requestOptions = {
                method: 'GET',
                url: `${this.options.baseUrl}/v1.0/form`,
                time: true,
                json: true,
                qs: qs,
                qsStringifyOptions: { arrayFormat: 'repeat' }
    ...
    editEntry(options) {
        ...
        return this._signinIfNeeded().then(() => {
            ...
            const requestOptions = {
                method: 'POST',
                url: `${this.options.baseUrl}/v1.0/entry/${options.entryId}/edit`,
                body: body,
                time: true,
                json: true,
            };
