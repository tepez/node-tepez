...
class TepezApi {
    ...
    optionsSetDeleteOptions(options) {
        ...
        const deleteOptionsUrl = `${this.options.baseUrl}/v1.0/optionsSet/${options.setId}/deleteOptions`;
        return this._signinIfNeeded().then(() => {
            const requestOptions = {
                method: 'POST',
    ...
    optionsSetAddOptions(options) {
        ...
        const addOptionsUrl = `${this.options.baseUrl}/v1.0/optionsSet/${options.setId}/addOptions`;
        return this._signinIfNeeded().then(() => {
            const requestOptions = {
                method: 'POST',
                url: addOptionsUrl,
    ...
    docsSetAddDocs(options) {
        ...
        const url = `${this.options.baseContribUrl}/${this._apiEnvPrefix}docsSets/docsSet/${options.accountId}/${options.docsSetId}/addDocs`;
        return this._signinIfNeeded().then(() => {
            const requestOptions = {
                method: 'POST',
                url: url,
